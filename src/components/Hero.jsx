...
const animatedIconMap = {
  "Payments Platform.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.rect x="2" y="5" width="20" height="14" rx="2" variants={pathVariants} />
      <motion.line x1="2" y1="10" x2="22" y2="10" variants={pathVariants} />
      <motion.line x1="6" y1="15" x2="10" y2="15" variants={pathVariants} />
    </svg>
  ),
  "Booking System.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      ...
      <motion.path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01M16 18h.01" variants={pathVariants} />
    </svg>
  ),
  "CRM Software.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
  ...
  "Manufacturing Software.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      ...
      <motion.path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" variants={pathVariants} />
    </svg>
  ),
  "Scheduling App.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.circle cx="12" cy="12" r="10" variants={pathVariants} />
      <motion.polyline points="12 6 12 12 16 14" variants={pathVariants} />
    </svg>
  ),
  "Property Management.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" variants={pathVariants} />
      <motion.polyline points="9 22 9 12 15 12 15 22" variants={pathVariants} />
    </svg>
  ),
  "Transportation Platform.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.rect x="1" y="3" width="15" height="13" rx="2" ry="2" variants={pathVariants} />
      <motion.polygon points="16 8 20 8 23 11 23 16 16 16 16 8" variants={pathVariants} />
      <motion.circle cx="5.5" cy="18.5" r="2.5" variants={pathVariants} />
      <motion.circle cx="18.5" cy="18.5" r="2.5" variants={pathVariants} />
    </svg>
  ),
  "Marketplace.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" variants={pathVariants} />
      <motion.line x1="3" y1="6" x2="21" y2="6" variants={pathVariants} />
      <motion.path d="M16 10a4 4 0 0 1-8 0" variants={pathVariants} />
    </svg>
  ),
  "Subscriptions.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.path d="M17 2.1l4 4-4 4" variants={pathVariants} />
      <motion.path d="M3 12a9 9 0 0 1 15-6.7L21 6" variants={pathVariants} />
      <motion.path d="M7 21.9l-4-4 4-4" variants={pathVariants} />
      <motion.path d="M21 12a9 9 0 0 1-15 6.7L3 18" variants={pathVariants} />
    </svg>
  ),
  "ERP Software.": (
    <svg viewBox="0 0 24 24" fill="none" stroke="#00D7A3" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
      <motion.polygon points="12 2 2 7 12 12 22 7 12 2" variants={pathVariants} />
      <motion.polyline points="2 17 12 22 22 17" variants={pathVariants} />
      <motion.polyline points="2 12 12 17 22 12" variants={pathVariants} />
    </svg>
  ),
};
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#071018] text-white flex items-center py-16 sm:py-20 lg:py-0">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 items-center">
        ...
        >
          <div className="relative w-full flex justify-center">
            ...
            >
              ...
              <svg className="absolute inset-0 h-full w-full pointer-events-none opacity-25" viewBox="0 0 560 560">
                <motion.path
        ...
        >
          <img src={logo} className="mb-6 sm:mb-10 h-8 sm:h-11 object-contain mx-auto lg:mx-0" alt="CodeBuddy Logo" />
          ...
          <p className="font-['Space_Grotesk'] mt-5 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed">
            ...
            development tools, and professional engineers—so what you build ships faster,
            costs less, and scales better.
          </p>
